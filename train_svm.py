...
for i in range(21):
    ...
    param = {
                 'kernel': ['rbf'],
                 'gamma': [0.5, 1e-1, 1e-3, 1e-7],
                 'C': [0.01, 0.1, 1, 10, 100, 1000]}

    clf = GridSearchCV(SVC(), n_jobs=8, param_grid=param, scoring='roc_auc', iid=False, cv=10)
...
test_ds.to_csv('submission_svm_21_all.csv', columns=['File', 'Class'], index=False)
